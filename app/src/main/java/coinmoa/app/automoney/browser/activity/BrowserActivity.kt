...
import coinmoa.app.automoney.IncognitoActivity
import coinmoa.app.automoney.R
import coinmoa.app.automoney.browser.*
...
import coinmoa.app.automoney.constant.LOAD_READING_URL
import coinmoa.app.automoney.controller.UIController
...
import coinmoa.app.automoney.dialog.BrowserDialog
import coinmoa.app.automoney.dialog.DialogItem
...
import coinmoa.app.automoney.interpolator.BezierDecelerateInterpolator
...
import coinmoa.app.automoney.settings.activity.SettingsActivity
import coinmoa.app.automoney.utils.*
import coinmoa.app.automoney.view.Handlers
import coinmoa.app.automoney.view.LightningView
import coinmoa.app.automoney.view.SearchView
...
//        finish()
        ...
        TedBackPressDialog.startDialog(this, getString(R.string.app_name), getString(R.string.ADMOB_KEY_BACKPRESS), getString(R.string.ADMOB_KEY_BACKPRESS), arrayOf(TedAdHelper.AD_ADMOB, TedAdHelper.AD_ADMOB), TedAdHelper.ADMOB_NATIVE_AD_TYPE.NATIVE_EXPRESS, false, object : OnBackPressListener {
            override fun onReviewClick() {
                val appPackageName = packageName // getPackageName() from Context or Activity object
                try {
                    startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "homegym.season.two.centras")))
                } catch (anfe: android.content.ActivityNotFoundException) {
                    startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + "homegym.season.two.centras")))
                }
        ...
        }) { imageView, imageUrl -> Glide.with(this@BrowserActivity).load(imageUrl).into(imageView) }
    }
