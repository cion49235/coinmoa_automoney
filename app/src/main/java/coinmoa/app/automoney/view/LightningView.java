...
import coinmoa.app.automoney.utils.UrlUtils;
...
//            mWebView.loadUrl(mActivity.getString(R.string.url), mRequestHeaders);
            mWebView.loadUrl(PreferenceUtil.getStringSharedData(mActivity,PreferenceUtil.PREF_URL,mActivity.getString(R.string.url)), mRequestHeaders);
        }
    }
